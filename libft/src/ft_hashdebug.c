...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2014/05/29 18:36:04 by mdufaud           #+#    #+#             */
/*   Updated: 2015/01/26 17:30:46 by mdufaud          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		ft_hashdebug(t_hash *hash)
{
	...
	ft_putendl(" octets.");
	if (hash->type == type_int || hash->type == type_char
			|| hash->type == type_fd || hash->type == type_charptr
			|| hash->type == type_addr)
