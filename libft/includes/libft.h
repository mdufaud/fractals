...
/*   Updated: 2015/01/26 17:29:36 by mdufaud          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
# define HASH_CHAR(key,value) ft_hashnew(key, &value, type_char, 1)
# define HASH_FD(key,value) ft_hashnew(key, &value, type_fd, sizeof(int))
# define HASH_ADDR(k,v) ft_hashnew(k, v, type_addr, sizeof(void *))
# define HASH_S(k,v) ft_hashnew(k, v, type_charptr, ft_strlen(k))
# define HASH_INTP(k,v,s) ft_hashnew(k, v, type_intptr, s)
# define HASH_TAB(k,v) ft_hashnew(k, v, t_tab, ft_tablen(v))
...
void				ft_printlist(int *l, unsigned int size);
